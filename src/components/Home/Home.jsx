  ...
  return (
    <div name='home' className=' w-full h-screen bg-[rgb(18,21,32)]'>
        ...
        <div className='max-w-[1000px] mx-auto px-11 flex flex-col justify-center  h-full' >
                ...
                <p className='text-[#8892b0] py-4 max-w-[700px]'> {'>'}23 Ano apaixonado por tecnologia e obcecado em aprender constantemente, procuro uma oportunidade como Desenvolvedor Web.</p>
