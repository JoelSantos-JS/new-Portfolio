    ...
    <div name='work' className='w-full md:h-screen text-gray-300 bg-[rgb(18,21,32)]'>
      ...
      <div className=' flex flex-col items-center py-8 justify-center mt-[150px] ' >
          ...
          <div  className='grid sm:grid-cols-2 md:grid-cols-2 gap-4 '>
            ...
            <div style={{backgroundImage:`url(${portfolio})` }} className='shadow-lg shadow-[#040c16] group container rounded-md flex justify-center items-center  mb-10 mx-auto container-div'>
